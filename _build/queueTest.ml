...
let test () : bool =
  ...
  enq 2 q;
  to_list q = [1;2]
;; run_test "enq on singleton" test
...
let test () : bool =
  ...
  truncate 1 q;
  to_list q = []
;; run_test "truncate on empty" test
...
let test () : bool =
  ...
  truncate 1 q;
  to_list q = [1]
;; run_test "truncate on non-empty x in front" test
...
let test () : bool =
  ...
  truncate 4 q;
  to_list q = [1;2;4]
;; run_test "truncate on non-empty x in middle" test
...
let test () : bool =
  ...
  enq 11 q; 
  truncate 11 q;
  to_list q = [1;2;4;10;11]
;; run_test "truncate on non-empty x at end" test
...
let test () : bool =
  ...
  truncate 10 q; 
  to_list q = [1;2;3]
;; run_test "truncate on non-empty x not in list" test
...
let test () : bool =
  ...
  delete 1 q;
  to_list q = []
;; run_test "delete on singleton" test
...
let test () : bool =
  ...
  delete 10 q; 
  to_list q = [1;2;5]
;; run_test "delete on non-empty multiple occurences" test
...
let test () : bool =
  ...
  delete 7 q; 
  to_list q = [1;10;5]
;; run_test "delete on non-empty not in list " test
